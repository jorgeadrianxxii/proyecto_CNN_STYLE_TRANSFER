# ¿Alguna vez te has preguntado como se vería un autorretrato tuyo si fuese pintado por picasso?
#### Esta pregunta surgió cuando buscaba ideas para el proyecto final del curso de Redes Neuronales de la Universidad de Sonora actualmente impartido por el Dr. Julio Waissman, antes siquiera de idear una respuesta para dicha pregunta mejor me dispuse a la tarea de buscar código por la internet de algún programa que hiciera algo parecido a pintar como picasso, pues había oido ya algo sobre las redes neuronales convolucionales y de su gran desempeño para extraer características de imágenes. El resultado de mi búsqueda, [este repositorio Github con el código original en el que esta basado este proyecto.](https://github.com/gsurma/style_transfer). Reproduciremos algunos resultados con el código encontrado.
